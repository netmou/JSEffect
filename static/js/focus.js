...
$.fn.KinSlideshow = function(settings){
	 ...
	 function KinSlideshow_setTitleFont(){
		 if(settings.isHasTitleFont){
			$(KinSlideshow_BoxObjectSelector+" .KinSlideshow_titleBar").append("<h2 class='title' style='margin:0 0 0 6px;padding:0;line-height:25px;'></h2>");	
	 ...
	 function KinSlideshow_setBtn(){
		 ...
		 if(settings.isHasBtn && KinSlideshow_imgaeLength >= 2){
			 ...
			 $(KinSlideshow_BoxObjectSelector+" .KinSlideshow_btnBox #btnlistID li").css({listStyle:"none",float:"left",width:14,height:14,borderWidth:settings.btn.btn_borderWidth,borderColor:settings.btn.btn_borderColor,borderStyle:"solid",background:settings.btn.btn_bgColor,textAlign:"center",cursor:"pointer",marginLeft:3,fontSize:12,fontFamily:settings.btn.btn_fontFamily,lineHeight:"14px",opacity:settings.btn.btn_bgAlpha,color:settings.btn.btn_fontColor});
